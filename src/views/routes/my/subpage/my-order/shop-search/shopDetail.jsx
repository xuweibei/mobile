...
class MySearch extends BaseComponent {
    constructor(props) {
        super(props);
        this.state = {
            ...
            height:
                ...
                - (window.isWX ? window.rem * 1.08 : window.rem * 1.08),
            status: -1, //tab状态
    ...
    render() {
        ...
        return (
            <div
                ...
                data-role="page"
                className={`online-transaction ${window.isWX ? 'WX' : ''}`}
            >
                {window.isWX ? null : (
                    <AppNavBar
                        title="线上订单"
...
export default connect(null, mapDispatchToProps)(MySearch);
