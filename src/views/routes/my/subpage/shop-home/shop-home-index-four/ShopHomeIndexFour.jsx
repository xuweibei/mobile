            ...
            <div data-component="ShopHomeIndex" data-role="page" className="ShopHomeIndex">
                <div className="shopHomeFourContent">
                    ...
                    <div className="hotRank" style={{background: shopModelArr.content.bg_color}}>
                        ...
                        <ul>
                            <li onClick={() => this.goToGoods(shopModelArr.content.sort2_pr1_id)}><img src={shopModelArr.picurl[4]} alt=""/></li>
                            <li onClick={() => this.goToGoods(shopModelArr.content.sort2_pr1_id)}><img src={shopModelArr.picurl[5]} alt=""/></li>
                            <li onClick={() => this.goToGoods(shopModelArr.content.sort2_pr1_id)}><img src={shopModelArr.picurl[6]} alt=""/></li>
                            <li onClick={() => this.goToGoods(shopModelArr.content.sort2_pr1_id)}><img src={shopModelArr.picurl[7]} alt=""/></li>
                        </ul>
                    </div>
