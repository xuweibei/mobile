                    ...
                    <div className="goods-right">
                        ...
                        <div className="goods-sku" onClick={this.skipDetail}>
                            ...
                            <div className="sku-right">
                                x{this.props.count || count}
                            </div>
                        </div>
                        <div className="goods-count">
                            记账量：{this.props.account || account}
                        </div>
                        <div className="right-bottom">
                            <div
                                className="total-count"
                                onClick={this.skipDetail}
                            >
                                总记账量：
                                <span>
                                    {this.props.totalAccount || totalAccount}
                                </span>
                            </div>
                            <div className="total-price">
                                <div className="total-price-left">
                                    共{this.props.goodsNum || goodsNum}件商品
                                </div>
                                <div className="total-price-right">
                                    合计：
                                    <span>
                                        {this.props.totalPrice || totalPrice}元
                                    </span>
                                </div>
                            </div>
                            <div className="buttons">
                                ...
                                {this.props.status === '等待发货' ? (
                                    <div
                                        ...
                                        onClick={this.goApplyService}
                                    >
                                        {this.props.look || look}
                                    </div>
                                ) : this.props.status === '等待付款' ? (
                                    <div
                                        className="look-button"
                                        onClick={() => console.log('quxiaodingdan')
                                        }
                                    >
                                        {this.props.look || look}
                                    </div>
                                    ...
                                    <div
                                        className="look-button"
                                        onClick={() => console.log('chakanwuliu')
                                        }
                                    >
                                        {this.props.look || look}
                                    </div>
                                ...
                                {this.props.status === '等待发货' ? (
                                    <div
                                        ...
                                        onClick={() => console.log('tixingfahuo')
                                        }
                                    >
                                    ...
                                    <div
                                        className="evaluate-button"
                                        style={this.props.style}
                                        oncClick={() => console.log('lijifukuan')
                                        }
                                    >
                                        {this.props.evaluate || evaluate}
                                    </div>
                                    ...
                                    <div
                                        className="evaluate-button"
                                        style={this.props.style}
                                        onClick={() => console.log('querenshouhuo')
                                        }
                                    >
                                        {this.props.evaluate || evaluate}
                                    </div>
                                    ...
                                    <div
                                        className="evaluate-button"
                                        style={this.props.style}
                                        onClick={() => console.log('lijipingjia')
                                        }
                                    >
                                        {this.props.evaluate || evaluate}
                                    </div>
